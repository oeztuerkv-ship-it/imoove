...
const ADMIN_NAV_GROUPS_RAW = [
  ...
  },
  {
    ...
    items: [
      ...
      { pageKey: "app-op-driver-rules", label: "Fahrer-Regeln", icon: "driver", navOrder: 7, roles: R.adminSvc },
      { pageKey: "app-op-booking-rules", label: "Buchungsregeln", icon: "document", navOrder: 8, roles: R.adminSvc },
      { pageKey: "app-op-system", label: "System", icon: "cog", navOrder: 9, roles: R.adminSvc },
    ],
  },
  {
    id: "insurer-kasse",
