...
const ADMIN_NAV_GROUPS_RAW = [
  ...
  },
  {
    ...
    items: [
      ...
      { pageKey: "app-op-tariffs", label: "Betrieb & Preise", icon: "map", navOrder: 5, roles: R.adminSvc },
      { pageKey: "app-op-regions", label: "Gebiete (Radius, Erweitert)", icon: "map", navOrder: 6, roles: R.adminSvc },
      { pageKey: "app-op-commission", label: "Provision", icon: "wallet", navOrder: 7, roles: R.adminSvc },
      { pageKey: "app-op-dispatch", label: "Dispatch", icon: "rides", navOrder: 8, roles: R.adminSvc },
      { pageKey: "app-op-features", label: "Funktionen", icon: "key", navOrder: 9, roles: R.adminSvc },
      { pageKey: "app-op-driver-rules", label: "Fahrer-Regeln", icon: "driver", navOrder: 10, roles: R.adminSvc },
      { pageKey: "app-op-booking-rules", label: "Buchungsregeln", icon: "document", navOrder: 11, roles: R.adminSvc },
      { pageKey: "app-op-system", label: "System", icon: "cog", navOrder: 12, roles: R.adminSvc },
    ],
  },
  {
    id: "insurer-kasse",
