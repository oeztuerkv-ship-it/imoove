...
const ADMIN_NAV_GROUPS_RAW = [
  ...
  },
  {
    ...
    items: [
      ...
      { pageKey: "app-faq", label: "App-FAQ", icon: "document", navOrder: 1, roles: R.adminSvc },
      { pageKey: "app-sponsors", label: "Exklusive Angebote", icon: "building", navOrder: 2, roles: R.adminSvc },
      { pageKey: "app-driver-messages", label: "Fahrer-Nachrichten", icon: "driver", navOrder: 3, roles: R.adminSvc },
      { pageKey: "app-op-tariffs", label: "Betrieb & Preise", icon: "map", navOrder: 4, roles: R.adminSvc },
      { pageKey: "app-op-regions", label: "Gebiete (Radius, Erweitert)", icon: "map", navOrder: 5, roles: R.adminSvc },
      { pageKey: "app-op-commission", label: "Provision", icon: "wallet", navOrder: 6, roles: R.adminSvc },
      { pageKey: "app-op-dispatch", label: "Dispatch", icon: "rides", navOrder: 7, roles: R.adminSvc },
      { pageKey: "app-op-features", label: "Funktionen", icon: "key", navOrder: 8, roles: R.adminSvc },
      { pageKey: "app-op-driver-rules", label: "Fahrer-Regeln", icon: "driver", navOrder: 9, roles: R.adminSvc },
      { pageKey: "app-op-booking-rules", label: "Buchungsregeln", icon: "document", navOrder: 10, roles: R.adminSvc },
      { pageKey: "app-op-system", label: "System", icon: "cog", navOrder: 11, roles: R.adminSvc },
    ],
  },
  {
    id: "insurer-kasse",
