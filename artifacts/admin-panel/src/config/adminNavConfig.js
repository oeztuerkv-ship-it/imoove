...
export const ADMIN_PAGE_ROLES = {
  ...
  "finance-payout-lines": ["admin", "service", "taxi", "insurance"],
  ...
  "company-vehicle-requests": ["admin", "service"],
...
const ADMIN_NAV_GROUPS_RAW = [
  ...
  },
  {
    ...
    items: [
      ...
      { pageKey: "cancellation-suspensions", label: "Storno- & Sperren", icon: "shield", navOrder: 0.25, roles: R.adminSvc },
      ...
      { pageKey: "partner-messages", label: "Nachrichten an Partner", icon: "document", navOrder: 5, roles: R.adminSvc },
      { pageKey: "app-op-tariffs", label: "Tarife", icon: "map", navOrder: 6, roles: R.adminSvc },
      { pageKey: "app-op-regions", label: "Gebiete", icon: "map", navOrder: 7, roles: R.adminSvc },
      { pageKey: "app-op-commission", label: "Provision", icon: "wallet", navOrder: 8, roles: R.adminSvc },
      { pageKey: "app-op-dispatch", label: "Dispatch", icon: "rides", navOrder: 9, roles: R.adminSvc },
      { pageKey: "app-op-features", label: "Funktionen", icon: "key", navOrder: 10, roles: R.adminSvc },
      { pageKey: "app-op-driver-rules", label: "Fahrer-Regeln", icon: "driver", navOrder: 11, roles: R.adminSvc },
      { pageKey: "app-op-booking-rules", label: "Buchungsregeln", icon: "document", navOrder: 12, roles: R.adminSvc },
      { pageKey: "app-op-system", label: "System", icon: "cog", navOrder: 13, roles: R.adminSvc },
    ],
  },
  {
    id: "insurer-kasse",
  ...
  },
  {
    ...
    items: [
      ...
      { pageKey: "finance-payout-lines", label: "Unternehmer-Auszahlungen", icon: "wallet", roles: ["admin", "service", "taxi", "insurance"] },
  ...
  },
  {
    ...
    items: [
      ...
      { pageKey: "company-vehicle-requests", label: "Anfragen · Fahrzeuge", icon: "rides", roles: R.adminSvc },
  ...
  },
  {
    ...
    items: [
      ...
      { pageKey: "legal-pages", label: "Rechtstexte", icon: "document", roles: R.adminSvc },
      { pageKey: "visitor-analytics", label: "Besucherstatistik", icon: "chart", roles: R.adminSvc },
...
const ADMIN_TOP_NAV = [
  ...
  },
  {
    ...
    children: [
      ...
      { pageKey: "cancellation-suspensions", label: "Storno- & Sperren" },
      ...
      { pageKey: "app-driver-messages", label: "Fahrer-Nachrichten" },
      { pageKey: "partner-messages", label: "Nachrichten an Partner" },
      { pageKey: "app-op-tariffs", label: "Tarife" },
  ...
  },
  {
    ...
    children: [
      ...
      { pageKey: "legal-pages", label: "Rechtstexte" },
      { pageKey: "visitor-analytics", label: "Besucherstatistik" },
