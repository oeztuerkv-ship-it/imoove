...
export default function DriverDashboard() {
  ...
  const { driver, loading: driverCtxLoading, logout, setAvailable, isBlocked, blockedUntilDate, blockDriver48h } = useDriver();

  useEffect(() => {
    if (driverCtxLoading) return;
    if (!driver) {
      router.replace("/");
    }
  }, [driverCtxLoading, driver]);
