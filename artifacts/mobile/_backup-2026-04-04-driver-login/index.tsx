            ...
            {onboardingCustomerStep === "social" ? null : (
              <>
                <FahrerRegistrierenFooter
                  ...
                  onAnmeldenPress={() => {
                    Haptics.impactAsync(Haptics.ImpactFeedbackStyle.Light);
                    router.push("/fahrer-login");
                  }}
                />
              </>
            )}

            {/* Fahrer: eigener Screen — nur Textlink (Tab-Bar liegt unter dem Vollbild-Onboarding). */}
            <Pressable
              style={{ alignSelf: "center", marginTop: obGap, paddingVertical: 10, paddingHorizontal: 8 }}
              onPress={() => {
                Haptics.impactAsync(Haptics.ImpactFeedbackStyle.Light);
                router.push("/fahrer-login");
              }}
            >
              <Text style={{ textAlign: "center", fontSize: isSmallScreen ? 13 : 14, fontFamily: "Inter_400Regular", color: colors.mutedForeground }}>
                Du bist Fahrer?{" "}
                <Text style={{ fontFamily: "Inter_600SemiBold", color: colors.primary }}>Zur Anmeldung</Text>
              </Text>
            </Pressable>
          </ScrollView>
        </View>
