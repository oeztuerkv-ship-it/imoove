...
export default function BookingMedicalScreen() {
  ...
  return (
    <View style={[styles.root, { backgroundColor: colors.background }]}>
      ...
      <ScrollView contentContainerStyle={{ padding: rs(16), gap: rs(12), paddingBottom: rs(120) }}>
        <Field label="Patient / Fahrgast" value={patientName} onChangeText={setPatientName} />
        <Field label="Abholadresse" value={pickupAddress} onChangeText={setPickupAddress} />
        <Field label="Zieladresse" value={destinationAddress} onChangeText={setDestinationAddress} />
        <View style={styles.row}>
          <Field label="Datum" value={appointmentDate} onChangeText={setAppointmentDate} style={{ flex: 1 }} />
          <Field label="Uhrzeit" value={appointmentTime} onChangeText={setAppointmentTime} style={{ flex: 1 }} />
        </View>
        <Toggle label="Hin- und Rückfahrt" value={returnRide} onPress={() => setReturnRide((v) => !v)} />
        {returnRide ? <Field label="Uhrzeit Rückfahrt" value={returnTime} onChangeText={setReturnTime} /> : null}

        <Field label="Krankenkasse" value={insuranceName} onChangeText={setInsuranceName} />
        <Field label="Kostenstelle / Vorgangsnummer" value={costCenter} onChangeText={setCostCenter} />
        <Field label="Genehmigungs-Referenz" value={authorizationReference} onChangeText={setAuthorizationReference} />
        ...
        <View style={styles.box}>
          ...
          <Field label="Hinweis für Fahrer" value={driverNote} onChangeText={setDriverNote} multiline />
        </View>
        ...
        {seriesMode ? (
          <View style={styles.box}>
            ...
            <View style={styles.row}>
              <Field label="Zeitraum von" value={seriesFrom} onChangeText={setSeriesFrom} style={{ flex: 1 }} />
              <Field label="bis" value={seriesTo} onChangeText={setSeriesTo} style={{ flex: 1 }} />
            </View>
