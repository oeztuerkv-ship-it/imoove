...
import adminCustomersRouter from "./adminCustomersRouter";
import adminCancellationSuspensionsRouter from "./adminCancellationSuspensionsRouter";
...
adminJson.use("/customers", adminCustomersRouter);
adminJson.use("/cancellation-suspensions", adminCancellationSuspensionsRouter);
