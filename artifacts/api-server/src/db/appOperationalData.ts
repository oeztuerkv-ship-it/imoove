...
const DEFAULT_PAYLOAD: Record<string, unknown> = {
  ...
  messages: {
    ...
    sponsorsTeaserBodyCustomerDe: "Entdecke Partner, Aktionen und Angebote in deiner Nähe.",
    sponsorsTeaserTitleDriverDe: "Exklusive Angebote für Fahrer",
    sponsorsTeaserBodyDriverDe: "Rabatte, Partneraktionen und exklusive Vorteile für deinen Alltag.",
  },
  tariffs: {
    active: true,
  ...
  dispatch: {
    ...
    /** Premium-Fahrer: Sekunden pro Stufe A→B→C bevor nächste Stufe am Markt erscheint. */
    premiumTierTimeoutSeconds: 30,
  },
  features: {
    normalRide: true,
    preBooking: true,
