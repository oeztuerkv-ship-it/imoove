import { canonicalGermanPlaceKey, haystackContainsMunicipality } from "./germanPlaceKey";

/**
 * Alle Gemeinden im Landkreis Esslingen (Taxameter-Pflichtkorridor).
 * Mobile: `artifacts/mobile/utils/esslingenCountyMunicipalities.ts` parallel pflegen.
 */
