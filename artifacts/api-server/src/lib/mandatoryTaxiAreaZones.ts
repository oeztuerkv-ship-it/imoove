/**
 * Koordinaten-basiertes Pflichtfahrgebiet (Taxameter) — unabhängig von Geocoding-Labels.
 * Mobile-Spiegel: `artifacts/mobile/utils/mandatoryTaxiAreaZones.ts` (Zonen synchron halten).
 */
...
/** Stuttgart, Landkreis Esslingen (Gemeinden), Leinfelden-Echterdingen, Filderstadt. */
