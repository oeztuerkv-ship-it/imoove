...
for f in index.html style.css script.js datenschutz.html agb.html impressum.html ueber-onroda.html fixpreise.html partner-status.html konto-loeschen.html onroda-brand.css; do
  if [[ ! -f "${TARGET}/${f}" ]]; then
