...
BEGIN
  ...
  IF NOT EXISTS (
    SELECT 1 FROM information_schema.tables
    WHERE table_schema = 'public' AND table_name = 'ride_driver_dispatch_offers'
  ) THEN
    errs := array_append(errs, 'table ride_driver_dispatch_offers (Migration 072)');
  END IF;

  IF NOT EXISTS (
    SELECT 1 FROM pg_indexes
    WHERE schemaname = 'public' AND indexname = 'ride_driver_dispatch_offers_ride_idx'
  ) THEN
    errs := array_append(errs, 'index ride_driver_dispatch_offers_ride_idx (Migration 072)');
  END IF;
  ...
  IF NOT EXISTS (
    SELECT 1 FROM information_schema.tables
    WHERE table_schema = 'public' AND table_name = 'partner_messages'
  ) THEN
    errs := array_append(errs, 'table partner_messages (Migration 082)');
  END IF;

  IF NOT EXISTS (
    SELECT 1 FROM information_schema.columns
    WHERE table_schema = 'public' AND table_name = 'partner_messages' AND column_name = 'created_by_admin'
  ) THEN
    errs := array_append(errs, 'partner_messages.created_by_admin (Migration 082)');
  END IF;

  IF NOT EXISTS (
    SELECT 1 FROM information_schema.columns
    WHERE table_schema = 'public' AND table_name = 'partner_messages' AND column_name = 'batch_id'
  ) THEN
  ...
  IF NOT EXISTS (
    SELECT 1 FROM information_schema.columns
    WHERE table_schema = 'public' AND table_name = 'admin_companies' AND column_name = 'onboarding_status'
  ) THEN
    errs := array_append(errs, 'admin_companies.onboarding_status (Migration 088)');
  END IF;

  IF NOT EXISTS (
    SELECT 1 FROM information_schema.tables
    WHERE table_schema = 'public' AND table_name = 'company_vehicles'
  ) THEN
    errs := array_append(errs, 'table company_vehicles (Migration 089)');
  END IF;
  ...
  IF NOT EXISTS (
    SELECT 1 FROM information_schema.columns
    WHERE table_schema = 'public' AND table_name = 'fleet_drivers' AND column_name = 'dispatch_priority'
  ) THEN
    errs := array_append(errs, 'fleet_drivers.dispatch_priority (Migration 105)');
  END IF;

  IF NOT EXISTS (
    SELECT 1 FROM information_schema.columns
    WHERE table_schema = 'public' AND table_name = 'rides' AND column_name = 'dispatch_tier'
  ) THEN
    errs := array_append(errs, 'rides.dispatch_tier (Migration 105)');
  END IF;

  IF NOT EXISTS (
    SELECT 1 FROM information_schema.columns
    WHERE table_schema = 'public' AND table_name = 'rides' AND column_name = 'dispatch_tier_started_at'
  ) THEN
    errs := array_append(errs, 'rides.dispatch_tier_started_at (Migration 105)');
  END IF;
  ...
  IF NOT EXISTS (
    ...
    errs := array_append(errs, 'fleet_drivers.last_market_lat (Migration 107)');
  END IF;
  ...
  IF NOT EXISTS (
    SELECT 1 FROM information_schema.columns
    WHERE table_schema = 'public' AND table_name = 'fleet_drivers' AND column_name = 'commission_rate'
  ) THEN
  ...
  IF NOT EXISTS (
    SELECT 1 FROM information_schema.columns
    WHERE table_schema = 'public' AND table_name = 'fleet_drivers' AND column_name = 'dispatch_reject_streak'
  ) THEN
    errs := array_append(errs, 'fleet_drivers.dispatch_reject_streak (Migration 110)');
  END IF;

  IF NOT EXISTS (
    SELECT 1 FROM information_schema.columns
    WHERE table_schema = 'public' AND table_name = 'rides' AND column_name = 'driver_passenger_rating'
  ) THEN
    errs := array_append(errs, 'rides.driver_passenger_rating (Migration 110)');
  END IF;

  IF NOT EXISTS (
    SELECT 1 FROM information_schema.columns
    WHERE table_schema = 'public' AND table_name = 'passenger_profiles' AND column_name = 'rating_sum'
  ) THEN
    errs := array_append(errs, 'passenger_profiles.rating_sum (Migration 110)');
  END IF;
  ...
  IF NOT EXISTS (
    SELECT 1 FROM information_schema.columns
    WHERE table_schema = 'public' AND table_name = 'rides' AND column_name = 'customer_mid_trip_abort_at'
  ) THEN
    errs := array_append(errs, 'rides.customer_mid_trip_abort_at (Migration 143)');
  END IF;
  ...
  IF NOT EXISTS (
    SELECT 1 FROM information_schema.columns
    WHERE table_schema = 'public' AND table_name = 'rides' AND column_name = 'payment_capture_next_retry_at'
  ) THEN
    errs := array_append(errs, 'rides.payment_capture_next_retry_at (Migration 111)');
  END IF;

  IF NOT EXISTS (
    SELECT 1 FROM information_schema.tables
    WHERE table_schema = 'public' AND table_name = 'customer_payment_suspension'
  ) THEN
    errs := array_append(errs, 'table customer_payment_suspension (Migration 111)');
  END IF;

  IF NOT EXISTS (
    SELECT 1 FROM information_schema.columns
    WHERE table_schema = 'public' AND table_name = 'rides' AND column_name = 'tip_amount'
  ) THEN
    errs := array_append(errs, 'rides.tip_amount (Migration 112)');
  END IF;

  IF NOT EXISTS (
    SELECT 1 FROM information_schema.columns
    WHERE table_schema = 'public' AND table_name = 'ride_financials' AND column_name = 'tip_amount'
  ) THEN
    errs := array_append(errs, 'ride_financials.tip_amount (Migration 112)');
  END IF;
  ...
  IF NOT EXISTS (
    SELECT 1 FROM information_schema.columns
    WHERE table_schema = 'public' AND table_name = 'rides' AND column_name = 'payout_amount'
  ) THEN
  ...
  IF NOT EXISTS (
    SELECT 1 FROM information_schema.tables
    WHERE table_schema = 'public' AND table_name = 'fleet_driver_cancellation_suspension'
  ) THEN
    errs := array_append(errs, 'table fleet_driver_cancellation_suspension (Migration 127)');
  END IF;

  IF NOT EXISTS (
    SELECT 1 FROM information_schema.columns
    WHERE table_schema = 'public' AND table_name = 'fleet_driver_cancellation_suspension' AND column_name = 'suspended_until'
  ) THEN
  ...
  IF NOT EXISTS (
    SELECT 1 FROM information_schema.tables
    WHERE table_schema = 'public' AND table_name = 'partner_private_reminders'
  ) THEN
    errs := array_append(errs, 'table partner_private_reminders (Migration 139)');
  END IF;

  IF NOT EXISTS (
    SELECT 1 FROM information_schema.columns
    WHERE table_schema = 'public'
      AND table_name = 'partner_private_reminders'
      AND column_name = 'fleet_driver_id'
  ) THEN
    errs := array_append(errs, 'partner_private_reminders.fleet_driver_id (Migration 140)');
  END IF;
  ...
  IF NOT EXISTS (
    ...
    errs := array_append(errs, 'partner_private_reminders.completed_at (Migration 141)');
  END IF;
